            ...
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    if ($title == 'Video Testimoni') {
                        ...
                        echo '<a class="nav-link active" href="' . base_url('admin_humas/video_testimoni') . '">';
                    } else {
                        echo '<a class="nav-link" href="' . base_url('admin_humas/video_testimoni') . '">';
                    }
                    ?>
                    <div class="sb-nav-link-icon"><i class="fas fa-video"></i></div>
                    Video Testimoni
...
<div class="sb-sidenav-menu-heading">Pendaftaran</div>
                    ...
                    if ($title == 'Media') {
                        //arahih ke controller admin
                        echo '<a class="nav-link active" href="' . base_url('admin_humas/media') . '">';
                    } else {
                        echo '<a class="nav-link" href="' . base_url('admin_humas/media') . '">';
                    }
                    ?>
                    <div class="sb-nav-link-icon"><i class="fas fa-dollar"></i></div>
                    Media Partner
                    ...
                    if ($title == 'Kampus') {
                        //arahih ke controller admin
                        echo '<a class="nav-link active" href="' . base_url('admin_humas/kampus') . '">';
                    } else {
                        echo '<a class="nav-link" href="' . base_url('admin_humas/kampus') . '">';
                    }
                    ?>
                    <div class="sb-nav-link-icon"><i class="fas fa-dollar"></i></div>
                    Kampus Partner
