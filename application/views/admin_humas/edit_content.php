...
<div id="layoutSidenav_content">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <?= form_open_multipart('admin_humas/update_content'); ?>
                    <div class="form-group">
                        <input type = "hidden" name = "id" value = "<?php echo $content['id_content'];?>" >
                        <label for="nama">Judul</label>
                        <input type="text" value = "<?php echo $content['judul'];?>" class="form-control" id="judul" name="judul" required>
                    </div>
                    ...
                    <div class="form-group">
                     <label class="form-label" for="message">Gambar</label
                        >
                    <br>
                    <img width = "300px" height = "100px" src = "<?php echo base_url('assets/img/content/').$content['gambar'];?>">
                        <input
                            class="form-control"
                            id="file-upload"
                            name="gambar"
