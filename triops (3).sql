...
(2, 'Panduan Pendaftaran Triop 2025', 'b96cd8fe1a579573938a9510baaee3ab.pdf');
...
CREATE TABLE `tb_jadwal` (
  ...
  `utama` int NOT NULL,
  `tiket` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `tb_jadwal` (`id_jadwal`, `id_sekolah1`, `id_sekolah2`, `tanggal`, `skor1`, `skor2`, `utama`, `tiket`) VALUES
(8, 1, 2, '2024-09-30 21:22:00', '', '', 0, ''),
(9, 1, 4, '2024-09-29 21:52:00', '1', '1', 1, 'https://www.goersapp.com/events/gita-nusa-indonesia-trinitas-symphony-orchestra--gniorkestrinitas'),
(10, 1, 3, '2024-10-01 05:20:00', '', '', 0, ''),
(11, 2, 4, '2024-10-02 05:20:00', '', '', 0, ''),
(12, 2, 3, '2024-10-04 05:20:00', '', '', 0, ''),
(13, 3, 4, '2024-10-05 05:21:00', '', '', 0, '');
...
CREATE TABLE `tb_videosejarah` (
  `id_videosejarah` int NOT NULL,
  `judul` text NOT NULL,
  `link` text NOT NULL,
  `tahun` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(1, 'TRIOP 2016', '7E1PXkOs_w4?si=qt_ReVjpZtgm7RPf', 2016),
(3, 'TRIOP 2018', 'fRVWnyy3RL4?si=yxwomHAB-EY6uJX1', 2018);
...
--
ALTER TABLE `tb_instagram`
  MODIFY `id_instagram` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tb_video`
  MODIFY `id_video` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tb_videosejarah`
--
ALTER TABLE `tb_videosejarah`
  MODIFY `id_videosejarah` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
